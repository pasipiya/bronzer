        ...
        <div class="col-lg-6 col-7">
          <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
            <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
              ...
              <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('importinquiry') }}">Import Quotation</a></li>
            </ol>
          </nav>
        </div>
        <div class="col-lg-6 col-5 text-right">

          <h6 class="h2 text-white d-inline-block mb-0">Import Quotation</h6>
        </div>
      </div>
      <!-- Card stats -->
    </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col">
                            <div class="custom-file">
                                ...
                                <label class="custom-file-label" for="customFileLang">Select Quotation XLSX file</label>
                            </div>
                        </div>
                        <div class="col text-right">
                            <button type="submit" class="btn btn-md btn-primary">Import Quotation</button>
            ...
            <div class="table-responsive">
               ...
               <table class="table align-items-center table-dark">
                <thead class="thead-dark">
                  <tr>
                    <th scope="col" class="sort" data-sort="name">Quotation Name</th>
                ...
                <tbody>
                  <tr>
                    <th scope="row">
                      <a href="" class="no-style"> Test Quotation <i class="fas fa-copy"></i></a>
                    </th>
                    <td>
                      2021-12-05
                    </td>
